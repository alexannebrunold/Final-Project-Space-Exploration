<template>
  <div class="popup page">
    ...
    <div class="popup__Content">
      ...
      <div class="popup__Content__Date">
        {{ currentPage.date }}
      </div>
    </div>
  </div>
  ...
  data() {
    return {
      ...
      "luna-1": {
        ...
        text:
          "Luna 1 (appelée aussi Lunik 1 ou Mechta) devait effectuer des mesures dans l'espace interplanétaire puis s'écraser sur le sol lunaire, mais elle rate sa cible et passe à environ 6 000 kilomètres de la Lune. Elle est la première des sondes soviétiques du programme Luna d'exploration lunaire qui s'acheva en 1976. La sonde Luna 1 marque le début de l'exploration spatiale.",
        date: "2 Janvier 1959",
      },
      "luna-2": {
      ...
      "luna-9": {
        ...
        text:
          "Luna 9 (appelée aussi Lunik 9 ou Objet 01954) qui a réussi le premier atterrissage en douceur sur la Lune. Les Soviétiques battent ainsi une fois de plus les Américains qui parviennent à poser Surveyor 1 le 2 juin 1966 à la première tentative. L'objectif de la mission Luna 9 était d'obtenir des informations sur les caractéristiques du sol lunaire.",
      ...
      "luna-11-14": {
        ...
        text:
          "Les sondes Luna 11 à 14 sont pour la majorité de grandes réussites avec des missions en tout genre comme prendre des photos depuis l'orbite lunaire (Luna 12), se poser en douceur sur la lune (Luna13) ou encore la Cartographie détaillée de la lune, mesure du champ de gravité et test des futurs systèmes de télécommunications (Luna 14).",
        date: "1966-1968",
      },
      "luna-16": {
      ...
      "luna-17": {
        ...
        subtitle: "Le premier échantillon lunaire",
        text:
          "Le vaisseau se posa sur la Lune le 17 novembre. Il déploya une double rampe qui permit à Lunokhod 1 de descendre vers la surface lunaire. Il fut déclaré officiellement inactif le 4 octobre 1971. Lunokhod a voyagé sur une distance de 10 540 mètres c'est le premier à transmettre plus de 20 000 images et 200 panoramas. Il a aussi effectué plus de 500 tests sur le sol lunaire.",
      ...
      "luna-18-23": {
        ...
        text:
          "Les lancements de la mission Luna entre 1971 et 1974 sont des séries de sondes qui vont récupérer des roches lunaire tout en parcourant sa surface (le rover Lunokhod 2 parcourt 37 km)",
        date: "1971-1974",
      },
      "luna-24": {
        ...
        text:
          "Ce fut la dernière sonde soviétique à se poser sur la Lune et à rapporter des échantillons de sol lunaire vers la Terre, près de 4 ans après la dernière mission humaine, Apollo 17.",
        date: "13 août 1976",
      },
      "apollo-1": {
        ...
        text:
          "Apollo 1 (initialement AS-204) devait être la quatrième mission du programme Apollo et la première emportant un équipage. Elle n’eut jamais lieu car un incendie se déclencha dans le module de commande du vaisseau lors d'une répétition au sol en conditions réelles, provoquant la mort de son équipage.",
      ...
      "apollo-2-6": {
        ...
        text:
          "Les déboires du vaisseau spatial Apollo permirent au programme de développement de la fusée géante Saturn V de rattraper son retard. Celle-ci avait en effet rencontré de nombreux problèmes touchant en particulier le deuxième étage  : excès de poids, phénomènes de vibration.",
        date: "1962-1968 ",
      },
      "apollo-7": {
      ...
      "apollo-8": {
        ...
        text:
          "À ce stade d'avancement du programme, il s'agit d'une mission risquée car une défaillance du moteur du vaisseau Apollo au moment de sa mise en orbite lunaire ou de son injection sur la trajectoire de retour aurait pu être fatale à l'équipage d'autant que le module lunaire a été remplacé par une maquette. Mais les dirigeants de la NASA redoutent un coup d'éclat des Soviétiques pour la fin de l'année et décident de courir le risque. Les astronautes font au total dix révolutions autour de la Lune. Durant ce vol, ils réalisent de nombreux clichés de la Lune dont le premier lever de Terre.",
      ...
      "apollo-13": {
        ...
        text:
          "Apollo 13 est la troisième mission du programme spatial américain Apollo ayant pour objet de conduire un équipage jusque sur la Lune. Les astronautes Jim Lovell et Fred Haise devaient se poser , tandis que Ken Mattingly devait rester en orbite. Mais la NASA pensait que ce dernier risquait d'attraper la rougeole du fait de la maladie d'un autre astronaute, et Jack Swigert fut envoyé à sa place. De plus, un accident grave, qui aurait pu être fatal pour l'équipage, se produisit durant le transit entre la Terre et la Lune et imposa l'abandon de la mission et le retour vers la Terre.",
        date: "11 avril 1970",
      },
      "apollo-14": {
      ...
      "apollo-15": {
        ...
        text:
          "Apollo 15 (26 juillet 1971 - 7 août 1971) est la cinquième mission ayant pour objectif de déposer un équipage à la surface de la Lune. Par rapport aux missions précédentes, Apollo 15 bénéficie d'un lanceur Saturn V plus puissant. Sa capacité accrue permet notamment de prolonger le séjour des astronautes à la surface la Lune (67 heures), de disposer d'un véhicule, le rover lunaire augmentant le rayon d'action durant les sorties extravéhiculaires et de ramener une masse plus importante d'échantillons de sol.",
