<template>
    ...
    <div class="endTimeline">
      ...
      <p class="endTimeline--paragraphe">
        ...
        de roche lunaire et de mettre en place plusieurs batteries d'instruments
        scientifiques. Les astronautes ont effectué des observations in situ au
        cours d'excursions sur le sol lunaire d'une durée pouvant atteindre huit
        heures, assistés à partir d'Apollo 15 par un véhicule tout-terrain, le
        <span>rover lunaire</span>
        . La NASA propose plusieurs types de mission dont le

        <span>lancement en orbite</span>
        d'une station spatiale, des séjours prolongés sur la Lune mettant en
        œuvre plusieurs nouveaux modules dérivés du LEM, une mission
        <span>habitée vers Mars</span>
        , le survol de Vénus par une mission habitée, etc. Mais les objectifs
        scientifiques trop vagues ne réussissent pas à convaincre le Congrès
        américain beaucoup moins motivé par les programmes spatiaux «
        post-Apollo ».
        <br />
        <br />
    ...
    return {
      ...
      tableauTimeline: [
        ...
        },
        {
          ...
          title: "Apollo-2-6",
          description:
            " mission non habitée, essai du lanceur Saturn V et du module lunaire.",
        },
        {
        ...
        },
        {
          ...
          date: "1970",
          description:
            "Cette mission à failli tourner au drame a cause de problèmes techniques.",
        },
        {
