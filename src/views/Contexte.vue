<template>
	<div class="context">
		...
		<div class="context__Button">
			<div class="context__Button__LearnMore">
				<PrimaryButton textPrimaryButton="En savoir plus" LearnPageName="ContexteSpoutnik" />
			</div>
			<div class="context__Button__Next">
...
export default {
	...
	data() {
		return {
			imageSrc: require("../assets/img/sergei_korolev.jpg"),
		}
	},
	components: {
		Info,
