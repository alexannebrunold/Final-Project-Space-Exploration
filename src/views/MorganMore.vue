<template>
	<div class="learn">
		<MoreInfo
			...
			textInfoRight="En 1963, Margaret Hamilton intègre le laboratoire Draper du MIT. Elle y supervise l’équipe chargée de développer les logiciels du programme spatial Apollo."
		/>
	</div>
</template>
